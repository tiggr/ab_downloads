...
class tx_abdownloads_module1 extends BaseScriptClass
{
    public $pageinfo;
    public $debug = false;
    public $tablePrefix = 'tx_abdownloads_';
     ...
     */
    public function getViewDownloadsToApprove()
    {
        global $LANG;
     ...
     * @return	string		The generated HTML source for this view.
     */
    public function getViewDownloadsReportedBroken()
    {
        global $LANG;
     ...
     * @return	string		The generated HTML source for this view.
     */
    public function getViewCheckForBrokenDownloads()
    {
        global $LANG;
     ...
     * @return	string		The generated HTML source for this view.
     */
    public function getViewImportCategoriesDownloadsDB($type = null, $table = null, $generateQuery = null)
    {
        global $LANG;
     ...
     * @return	string		The generated HTML source for this view.
     */
    public function getViewImportCategoriesDownloadsCSV($type = null, $importCSV = null, $overwriteExisting = null)
    {
        global $LANG;
     ...
     * @return	string		The generated HTML source for this view.
     */
    public function getViewExportCategoriesDownloads($type = null, $properties = null, $outputFormat = null, $generateOutput = null)
    {
     ...
     * @return	void
     */
    public function doAcceptDownload($uid = null)
    {
        if ($uid != null) {
     ...
     * @return	void
     */
    public function doDisableDownload($uid = null)
    {
        if ($uid != null) {
            // Update the download record
            $theTable = $this->tablePrefix . 'download';
     ...
     * @return	void
     */
    public function doDeleteDownload($uid = null)
    {
        if ($uid != null) {
     ...
     */
    public function doCheckDownload($file)
    {
        if ($file == null) {
            return false;
        }
     ...
     */
    public function generateOutput($type = null, $properties = null, $outputFormat = null, $identifier = null)
    {
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">';
     ...
     */
    public function calculatePercent($count, $totalCount)
    {
        if (!$totalCount) {
            $totalCount = 1;
        }
     ...
     */
    public function getTemplateField($field, $string)
    {
        // Get template config
     ...
     */
    public function existingEntry($uid = null, $table = null)
    {
