...
class tx_abdownloads_tceFunc_selectTreeView extends AbstractTreeView
{
     ...
     * @return	[type]		...
     */
    public function getTitleStyles($v)
    {
        $style = '';
...
class tx_abdownloads_treeview
{
     ...
     * @return	[type]		...
     */
    public function renderCatTree($cmd = '')
    {
     ...
     * @return	[type]		...
     */
    public function getCatRootline($selectedItems, $SPaddWhere)
    {
     ...
     */
    public function renderCategoryFields()
    {
        $PA = &$this->PA;
        // 		$fobj = &$this->fobj;
     ...
     */
    public function getNotAllowedItems(&$PA, $SPaddWhere, $allowedItemsList = false)
    {
    ...
    if (defined('TYPO3') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ab_downloads/lib/class.tx_abdownloads_treeview.php']) {
